...
text(1,1.1,'cell set 2','color',0.8*[1 1 1],'fontangle','normal','HorizontalAlignment','right','fontsize',8);
text(.4,1.1,'cell set 1','color',cpc(1,:),'fontangle','normal','HorizontalAlignment','right','fontsize',8);
...
for n = [1 10 100 1000]
	...
	if t==1
		...
		hp=my_subplot(5,8,28+t,[xh*.9 yh*.9]);
		hp.Position(2)=hp.Position(2)-.07;
		hp.Position(1)=hp.Position(1)+.03*(4-t);
	end
